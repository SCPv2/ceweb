...
echo "   psql -h $DB_SERVER_HOST -p $DB_PORT -U ceadmin -d cedb -c \"SELECT 1;\""
...
log "- DB 서버: db.your_private_domain_name.net:2866 (기본값) (외부)"
...
log "- DB는 별도 서버(db.your_private_domain_name.net:2866 (기본값))에 위치합니다"

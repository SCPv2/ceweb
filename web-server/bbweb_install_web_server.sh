...
# 5. BBWEB Server 도메인 설정 (master_config.json 기반)
...
log "✅ BBWEB Server 도메인이 master_config.json 기반으로 설정되었습니다"
...
log "- 도메인 접근: http://www.your_public_domain_name.net/artist/bbweb/index_lb.html"
